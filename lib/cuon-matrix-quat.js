...
Matrix4.prototype.multiplyVector3 = function(pos) {
  ...
  result[0] = pos['x'] * e[0] + pos['y'] * e[4] + pos['z'] * e[ 8] + e[11];
  result[1] = pos['x'] * e[1] + pos['y'] * e[5] + pos['z'] * e[ 9] + e[12];
  result[2] = pos['x'] * e[2] + pos['y'] * e[6] + pos['z'] * e[10] + e[13];
...
//--------------------------------------
  ...
  mult: function (q) {
    var xx = this.w * q.x + this.x * q.w + this.y * q.z - this.z * q.y;
    var yy = this.w * q.y + this.y * q.w + this.z * q.x - this.x * q.z;
    var zz = this.w * q.z + this.z * q.w + this.x * q.y - this.y * q.x;
